...
const styles: Record<string, string> = {
  gray: `${base} border-line bg-accent-soft text-ink focus-visible:outline-focus`,
  amber: `${base} border-amber-300/80 bg-amber-50 text-amber-950 focus-visible:outline-amber-500 dark:border-amber-700 dark:bg-amber-950/60 dark:text-amber-100`,
  green: `${base} border-emerald-300/80 bg-emerald-50 text-emerald-950 focus-visible:outline-emerald-500 dark:border-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-100`,
  blue: `${base} border-sky-300/80 bg-sky-50 text-sky-950 focus-visible:outline-sky-500 dark:border-sky-800 dark:bg-sky-950/50 dark:text-sky-100`,
}
